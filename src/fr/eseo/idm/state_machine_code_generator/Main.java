...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        private static void createAndSave() throws IOException {
	        ...
	        greenToYellow.getActions().add(turnOffGreen);
	        greenToYellow.getActions().add(turnOnYellow);
	        ...
	        yellowToRed.getActions().add(turnOffYellow);
	        yellowToRed.getActions().add(turnOnRed);
	       ...
	       redToGreen.getActions().add(turnOffRed);
	       redToGreen.getActions().add(turnOnGreen);
